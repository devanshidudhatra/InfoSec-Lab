...
void process_plaintext(char* plaintext) {
...
void encrypt_pair(char a, char b, int matrix[5][5], char* ciphertext) {
...
int main() {
    ...
    for (int i = 0; i < len; i += 2) {
        encrypt_pair(plaintext[i], plaintext[i + 1], matrix, ciphertext + cipher_index);
        cipher_index += 2;
    }
